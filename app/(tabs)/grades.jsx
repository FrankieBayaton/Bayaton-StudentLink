...
export default function Grades() {
  ...
  const [subjects, setSubjects] = useState([
    { id: "1", name: "Programming", grade: 95 },
    { id: "2", name: "Database", grade: 90 },
    { id: "3", name: "Networking", grade: 88 },
    { id: "4", name: "Web Development", grade: 92 },
    { id: "5", name: "Systems Analysis", grade: 89 },
  ]);
  ...
  const addOrUpdateSubject = () => {
    ...
    if (editingId) {
      setSubjects((prev) =>
        prev.map((item) =>
          item.id === editingId
            ? { ...item, name: newSubject.trim(), grade: gradeNum }
            : item
        )
      );
      setEditingId(null);
      ...
      setSubjects((prev) => [
        ...prev,
        { id: newId, name: newSubject.trim(), grade: gradeNum },
      ]);
    }
